...
2. From the Fastpath host (e.g., 54.172.102.176), run `./scripts/pull_kernel_artifacts.sh --host 13.218.155.222` and verify `~/kernels/6.18.0/config.stock` exists locally.
...
6. On the Fastpath host, rerun the pull script (`./scripts/pull_kernel_artifacts.sh --host 13.218.155.222`).
